...
const polkitRuleFile = "99_silentguard_core.rules"
...
func restartAsAdmin(save bool) {
	...
	args = append(args, pkexecPath, "sh", "-c", "exec sudo \"${0}\" \"${@}\"", "env", "NEKOBOX_APPIMAGE_CUSTOM_EXECUTABLE=silentguard_core", executablePath, "-ruleset-cache-directory", internal.GetRulesetCachedir())
