...
QMap<QString, QString> & ThemeManager::getThemes(){
    ...
    if (!initialized){
        initialized = true;
    //    ReadFileText(":silentguard/qss/styles.list");
    }
    return map;
}
...
std::tuple<QString, bool> ThemeManager::getPath(const QString & theme){
    ...
    else if (lowerTheme == "dark"){ return std::make_tuple(":silentguard/qss/MaterialDark.qss", true); } 
    else if (lowerTheme == "amoled"){ return std::make_tuple(":silentguard/qss/AMOLED.qss", true); } 
    else if (lowerTheme == "aqua") { return std::make_tuple(":silentguard/qss/Aqua.qss", true); } 
    else if (lowerTheme == "kawaii") { return std::make_tuple(":silentguard/qss/Kawaii.qss", true); } 
    else if (lowerTheme == "flatgray") { return std::make_tuple(":silentguard/qss/flatgray.css", true); } 
    else if (lowerTheme == "lightblue") { return std::make_tuple(":silentguard/qss/lightblue.css", true); } 
    else if (lowerTheme == "blacksoft"){ return std::make_tuple(":silentguard/qss/blacksoft.css", true); } 
