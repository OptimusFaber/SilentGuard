...
#define LOCAL_SERVER_PREFIX "silentguard-"
...
#ifdef Q_OS_UNIX
{
    ...
    QApplication::setApplicationName("silentguard");
    ...
    dir_success &= isFileAppendable("silentguard.cfg");
    ...
    bool supported = Configs::resourceManager->symlinks_supported = createSymlink(getApplicationPath(), "resources/silentguard_symlink_test.lnk");
    if (supported){
        QFile::remove("resources/silentguard_symlink_test.lnk");
